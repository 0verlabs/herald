/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a906e753a1dd81cdab576e21d344667b)
// Runtime types generated with workerd@1.20260730.1 2026-07-22 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	PRIVY_APP_ID: string;
	PRIVY_APP_SECRET: string;
	PRIVY_WEBHOOK_SIGNING_SECRET: string;
	PRIVY_AUTHORIZATION_ID: string;
	...
	MOONSHOTAI_API_URL: string;
	MINIMAX_API_URL: string;
	ALIBABA_API_URL: string;
	ZHIPUAI_API_URL: string;
	ANTHROPIC_API_KEY: string;
	OPENAI_API_KEY: string;
	DEEPSEEK_API_KEY: string;
	MOONSHOTAI_API_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PRIVY_APP_ID" | "PRIVY_APP_SECRET" | "PRIVY_WEBHOOK_SIGNING_SECRET" | "PRIVY_AUTHORIZATION_ID" | "PRIVY_AUTHORIZATION_PRIVATE_KEY" | "CLERK_PUBLISHABLE_KEY" | "CLERK_SECRET_KEY" | "ANTHROPIC_API_URL" | "OPENAI_API_URL" | "DEEPSEEK_API_URL" | "MOONSHOTAI_API_URL" | "MINIMAX_API_URL" | "ALIBABA_API_URL" | "ZHIPUAI_API_URL" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "DEEPSEEK_API_KEY" | "MOONSHOTAI_API_KEY" | "MINIMAX_API_KEY" | "ALIBABA_API_KEY" | "ZHIPUAI_API_KEY">> {}
}
